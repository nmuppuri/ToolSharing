...
class MessageDetailsRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private static final int TYPE_ONE = 1;
    private static final int TYPE_TWO = 2;

    private ArrayList<MessageDetails_Pojo> itemList;
    // Constructor of the class
    public MessageDetailsRecyclerAdapter(ArrayList<MessageDetails_Pojo> itemList, Context applicationContext) {
